...
//Following enum is created because switch in Key Event doesn't take strings
//Need this enum to convert string <-> int
enum Key_Codes{
	F1,
	F2,
	F3,
...
public:
	...
	vtkImageInteractionCallback() {
			...
			this->sub_angle_adjust_3[0] = 0;
			this->sub_angle_adjust_3[1] = 0;
			this->sub_angle_adjust_3[2] = 0;
			...
			this->win_center_x = 0;
			this->win_center_y = -0.8;			

			this->video_mode = false;			

			this->videoPlayer = new VideoPlayer();
			this->video_specific_cut_index = 0;

			this->current_F_Mode = Volume;

			this->switch_frames = false;

			this->guid_is_visible = false;
			this->orientation_visible = false;
			this->lock_volume_settings = false;

			this->internal_counter_video_loop = 0;
			this->internal_counter_volume_loop = 0;	
			this->internal_counter_video_loop_limit = 1;
			this->internal_counter_volume_limit = 0;


			video_location_Par_LAX[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\LAX Color\\";
			video_location_Par_LAX[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Par_LAX[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\LAX Mmode\\";

			video_location_Par_RVOT[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\RVOT Color\\";
			video_location_Par_RVOT[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\RVOT Doppler\\";
			video_location_Par_RVOT[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\RVOT PV Mmode\\";

			video_location_Par_RVIN[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\RVIN Color\\";
			video_location_Par_RVIN[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Par_RVIN[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Mmode\\";	

			video_location_Par_SAX_Base[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\SAX base color\\";
			video_location_Par_SAX_Base[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\SAX Base Doppler\\";
			video_location_Par_SAX_Base[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\SAX base Mmode\\";

			video_location_Par_SAX_Mitral[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default color\\";
			video_location_Par_SAX_Mitral[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Par_SAX_Mitral[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\SAX Mitral Mmode\\";


			video_location_Api_4_Chamber_1[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 4 cham color\\";
			video_location_Api_4_Chamber_1[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 4 cham mitral Doppler\\";
			video_location_Api_4_Chamber_1[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Api_4_Chamber_2[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 4 cham color 2\\";
			video_location_Api_4_Chamber_2[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 4 cham Doppler 2\\";
			video_location_Api_4_Chamber_2[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Api_5_Chamber[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 5 cham color\\";
			video_location_Api_5_Chamber[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Apical 5 cham aortic Doppler\\";
			video_location_Api_5_Chamber[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";


			video_location_Sub_Coronal_Posterior[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal coronal Post color\\";
			video_location_Sub_Coronal_Posterior[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Coronal_Posterior[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Coronal_Anterior[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal coronal Ant color\\";
			video_location_Sub_Coronal_Anterior[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Coronal_Anterior[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Coronal_Aorta[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal coronal Aorta color\\";
			video_location_Sub_Coronal_Aorta[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Coronal_Aorta[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Sagital_Bicaval[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal Sagital Bicaval color\\";
			video_location_Sub_Sagital_Bicaval[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal Bicaval SVC Doppler\\";
			video_location_Sub_Sagital_Bicaval[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Sagital_RVOT[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal Sagital RVOT color\\";
			video_location_Sub_Sagital_RVOT[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Sagital_RVOT[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Transverse[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal tranverse cut\\";
			video_location_Sub_Transverse[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Transverse[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Longitudanal_Aorta[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal Long Aorta color\\";
			video_location_Sub_Longitudanal_Aorta[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Longitudanal_Aorta[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sub_Longitudanal_IVC[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Subcostal Long IVC color\\";
			video_location_Sub_Longitudanal_IVC[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sub_Longitudanal_IVC[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";


			video_location_Sup_Aortic_Arch[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Suprasternal Aortic arch color\\";
			video_location_Sup_Aortic_Arch[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sup_Aortic_Arch[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sup_Ductal_Cut[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Suprasternal Ductal cut color\\";
			video_location_Sup_Ductal_Cut[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sup_Ductal_Cut[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Sup_Crab_View[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Suprasternal Crab view color\\";
			video_location_Sup_Crab_View[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Sup_Crab_View[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";

			video_location_Default[Color] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default color\\";
			video_location_Default[Doppler] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default Doppler\\";
			video_location_Default[MMode] = "C:\\VETS Source Code\\VETS 3D\\Video Frames\\Default M mode\\";
	};				
	...
	{		
		...
		{
			//cout<<"Subcostal window detected"<<endl;

			double azimuth, elevation, roll;
			GetSensorOrientation(&azimuth, &elevation, &roll);

			if(azimuth >= this->subcostal_window_1->min_azimuth && azimuth <= this->subcostal_window_1->max_azimuth &&
				elevation >= this->subcostal_window_1->min_elevation && elevation <= this->subcostal_window_1->max_elevation &&
				roll >= this->subcostal_window_1->min_roll && roll <= this->subcostal_window_1->max_roll){
				//cout<<"Subcostal window 1 detected"<<endl;
				return Cardiac_Windows::Subcostal_1;
			}

			else if(azimuth >= this->subcostal_window_2->min_azimuth && azimuth <= this->subcostal_window_2->max_azimuth &&
				elevation >= this->subcostal_window_2->min_elevation && elevation <= this->subcostal_window_2->max_elevation &&
				roll >= this->subcostal_window_2->min_roll && roll <= this->subcostal_window_2->max_roll){
				//cout<<"Subcostal window 2 detected"<<endl;
				return Cardiac_Windows::Subcostal_2;
			}

			else if(azimuth >= this->subcostal_window_3->min_azimuth && azimuth <= this->subcostal_window_3->max_azimuth &&
				elevation >= this->subcostal_window_3->min_elevation && elevation <= this->subcostal_window_3->max_elevation &&
				roll >= this->subcostal_window_3->min_roll && roll <= this->subcostal_window_3->max_roll){
				//cout<<"Subcostal window 3 detected"<<endl;
				return Cardiac_Windows::Subcostal_3;
			}
		}
	...
	void GetVideoLocation()
	{
		switch(this->video_specific_cut_index)
		{
		case Par_LAX:
			this->current_video_location = video_location_Par_LAX[this->current_F_Mode];
			break;

		case Par_RVOT:
			this->current_video_location = video_location_Par_RVOT[this->current_F_Mode];
			break;

		case Par_RVIN:
			this->current_video_location = video_location_Par_RVIN[this->current_F_Mode];
			break;

		case Par_SAX_Base:
			this->current_video_location = video_location_Par_SAX_Base[this->current_F_Mode];
			break;

		case Par_SAX_Mitral:
			this->current_video_location = video_location_Par_SAX_Mitral[this->current_F_Mode];
			break;


		case Api_4_Chamber_1:
			this->current_video_location = video_location_Api_4_Chamber_1[this->current_F_Mode];
			break;

		case Api_4_Chamber_2:
			this->current_video_location = video_location_Api_4_Chamber_2[this->current_F_Mode];
			break;

		case Api_5_Chamber:
			this->current_video_location = video_location_Api_5_Chamber[this->current_F_Mode];
			break;


		case Sub_Coronal_Posterior:
			this->current_video_location = video_location_Sub_Coronal_Posterior[this->current_F_Mode];
			break;

		case Sub_Coronal_Anterior:
			this->current_video_location = video_location_Sub_Coronal_Anterior[this->current_F_Mode];
			break;

		case Sub_Sagital_Bicaval:
			this->current_video_location = video_location_Sub_Sagital_Bicaval[this->current_F_Mode];
			break;

		case Sub_Transverse:
			this->current_video_location = video_location_Sub_Transverse[this->current_F_Mode];
			break;

		case Sub_Longitudanal_Aorta:
			this->current_video_location = video_location_Sub_Longitudanal_Aorta[this->current_F_Mode];
			break;

		case Sub_Longitudanal_IVC:
			this->current_video_location = video_location_Sub_Longitudanal_IVC[this->current_F_Mode];
			break;

		case Sub_Coronal_Aorta:
			this->current_video_location = video_location_Sub_Coronal_Aorta[this->current_F_Mode];
			break;

		case Sub_Sagital_RVOT:
			this->current_video_location = video_location_Sub_Sagital_RVOT[this->current_F_Mode];
			break;


		case Sup_Aortic_Arch:
			this->current_video_location = video_location_Sup_Aortic_Arch[this->current_F_Mode];
			break;

		case Sup_Ductal_Cut:
			this->current_video_location = video_location_Sup_Ductal_Cut[this->current_F_Mode];
			break;

		case Sup_Crab_View:
			this->current_video_location = video_location_Sup_Crab_View[this->current_F_Mode];
			break;		

		case No_Specific_Cut:
			this->current_video_location = video_location_Default[this->current_F_Mode];
		}					
	}
	...
	void CheckForSpecificCuts()
	{
		...
		string displayText;
		if(orientation_visible) 
			displayText = ss_a.str() + "," + ss_e.str() +"," + ss_r.str();
		
		this->video_specific_cut_index = No_Specific_Cut;

		switch(this->current_cardiac_window)
		{
		case Parasternal:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Parasternal, azimuth, elevation, roll);
				
				switch(this->video_specific_cut_index)
				{
				case Par_LAX:
					displayText = "Parasternal Long axis detected";
					break;

				case Par_RVOT:
					displayText = "Parasternal RVOT detected";
					break;

				case Par_RVIN:
					displayText = "Parasternal RVIN detected";
					break;

				case Par_SAX_Base:
					displayText = "Parasternal SAX Base detected";
					break;

				case Par_SAX_Mitral:
					displayText = "Parasternal SAX Mitral detected";
					break;				
				}
		...
		case Apical:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Apical, azimuth, elevation, roll);

				switch(this->video_specific_cut_index)
				{
				case Api_4_Chamber_1:
					displayText = "Apical 4 Chamber detected";
					break;
				...
				case Api_5_Chamber:
					displayText = "Apical 5 Chamber Base detected";
					break;
				}
		...
		case Suprasternal:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Suprasternal, azimuth, elevation, roll);

				switch(this->video_specific_cut_index)
				{
				case Sup_Aortic_Arch:
					displayText = "Suprasternal Aortic Arch detected";
					break;

				case Sup_Ductal_Cut:
					displayText = "Suprasternal Ductal Cut detected";
					break;

				case Sup_Crab_View:
					displayText = "Suprasternal Crab View detected";
					break;
				}
		...
		case Subcostal_1:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Subcostal_1, azimuth, elevation, roll);

				switch(this->video_specific_cut_index)
				{
				case Sub_Coronal_Posterior:
					displayText = "Subcostal Coronal Posterior detected";
					break;

				case Sub_Coronal_Anterior:
					displayText = "Subcostal Coronal Anterior detected";
					break;

				case Sub_Coronal_Aorta:
					displayText = "Subcostal Coronal Aorta detected";
				}
		...
		case Subcostal_2:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Subcostal_2, azimuth, elevation, roll);

				switch(this->video_specific_cut_index)
				{
				case Sub_Transverse:
					displayText = "Subcostal Transverse detected";
					break;

				case Sub_Longitudanal_Aorta:
					displayText = "Subcostal Longitudanal Aorta detected";
					break;

				case Sub_Longitudanal_IVC:
					displayText = "Subcostal Longitudanal IVC detected";
					break;
				}
		...
		case Subcostal_3:
			{
				this->video_specific_cut_index = videoPlayer->GetSpecificCut(Subcostal_3, azimuth, elevation, roll);

				switch(this->video_specific_cut_index)
				{
				case Sub_Sagital_Bicaval:
					displayText = "Subcostal Bicaval detected";
					break;

				case Sub_Sagital_RVOT:
					displayText = "Subcostal Sagital RVOT detected";
					break;
				}
			}
		}
	...
	void SliceVolumes()
	{
		...
		if(this->internal_counter_volume_loop < this->internal_counter_volume_limit)
		{
			this->switch_frames = false;
			this->internal_counter_volume_loop++;
		}

		else 
		{
			this->switch_frames = true;
			this->internal_counter_volume_loop = 0;
		}
		...
		case Cardiac_Windows::Subcostal_3:
			imageslice_sub_3[this->current_volume_index]->SetVisibility(0);
			break;
		...
		case Cardiac_Windows::Subcostal_3:
			imageslice_sub_3[this->current_volume_index]->SetVisibility(1);
			matrix_= imageslice_sub_3[this->current_volume_index]->GetMatrix();
			matrix_->MultiplyPoint(default_viewup, this->view_up);
			break;
	...
	void LoopVideos()
	{
		...
		if(this->internal_counter_video_loop < this->internal_counter_video_loop_limit)
		{
			...
			if(this->video_previous_index > -1)
					video_frame_actor[this->video_previous_index]->SetVisibility(0);

				video_frame_actor[this->video_current_index]->SetVisibility(1);

			this->video_previous_index = this->video_current_index;

			this->video_current_index++;
			
			if(this->video_current_index == this->video_current_max_index)
	...
	int GetInt(string keycode)
	{
		if(keycode == "F1") return F1;
		if(keycode == "F2") return F2;
		if(keycode == "F3") return F3;
		if(keycode == "F4") return F4;
		if(keycode == "F9") return F9;
		if(keycode == "F10") return F10;
		if(keycode == "F12") return F12;
		if(keycode == "s") return Save;
		if(keycode == "c") return Calculations;
		if(keycode == "Tab") return Invert_View;
		else return -1;
	}
	...
	{					
		...
		if(event == vtkCommand::KeyPressEvent)
		{
			...
			case F2:
				{
					...
					this->current_F_Mode = Color;
					this->GetVideoLocation();
					this->video_previous_index = -1;
					this->video_current_index = 0;					
					vector<string> file_names;
					ReadFolder(this->current_video_location, file_names);
					this->video_current_max_index = file_names.size();
					this->video_renderer->RemoveAllViewProps();
					//Set input to video frames
					for(int i = 0; i < this->video_current_max_index; i++)
					{						
						vtkSmartPointer<vtkJPEGReader> jpegReader = vtkSmartPointer<vtkJPEGReader>::New();
						jpegReader->SetFileName(file_names[i].c_str());
						jpegReader->Update();

						this->video_frame_actor[i]->SetInput(jpegReader->GetOutput());						
						this->video_frame_actor[i]->SetVisibility(0);
						this->video_renderer->AddActor(this->video_frame_actor[i]);
					}
			...
			case F9:
				this->guid_is_visible = !this->guid_is_visible;
				if(this->guid_is_visible)
					this->guid_renderer->DrawOn();
				else this->guid_renderer->DrawOff();
				break;

			case F10:
				this->orientation_visible = !this->orientation_visible;

				/*if(this->orientation_visible)
					this->textActor->DrawOn();
				else
					this->textActor->VisibleOff();*/
				break;

			case F12:
				this->lock_volume_settings = !this->lock_volume_settings;
				break;
			case Calculations:
				{
					CalculationsPackage::MainForm^ calculationsPackage = gcnew MainForm();
			...
			case Save:
				{
					...
					switch(this->current_cardiac_window){
					case Parasternal:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Parasternal.txt");
						break;

					case Apical:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Apical.txt");
						break;

					case Suprasternal:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Suprasternal.txt");
						break;

					case Subcostal_1:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_1.txt");
						break;

					case Subcostal_2:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_2.txt");
						break;

					case Subcostal_3:
						myfile.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_3.txt");
						break;
					...
					for(int i = 0; i < 4; i++){
						for(int j = 0; j < 4; j++){
							...
							case Subcostal_3:
								...
								myfile << imageslice_sub_3[this->current_volume_index]->GetMatrix()->GetElement(i,j)<<endl;
								break;
			...
			if(!this->lock_volume_settings)
				return;

			if(key == "f" || key == "v" || key == "g" || key == "b" || key == "h" || key == "n")
			{
				...
				case Cardiac_Windows::Subcostal_3:
					angle_adjust = this->sub_angle_adjust_3;
					break;
				...
				else if(key == "v" && angle_adjust[0] > -180)
				{
					this->guidance_volume->RotateX(-1);
				...
				else if(key == "g" && angle_adjust[1] < 180)
				{
				...
				else if(key == "b" && angle_adjust[1] > -180)
				{
					this->guidance_volume->RotateY(-1);
				...
				else if(key == "h" && angle_adjust[2] < 180)
				{
				...
				else if(key == "n" && angle_adjust[2] > -180)
				{
					this->guidance_volume->RotateZ(-1);
				...
				case Cardiac_Windows::Subcostal_3:
					for(int i = 0; i < 13; i++){
						imageslice_sub_3[i]->RotateX(x);
						imageslice_sub_3[i]->RotateY(y);
						imageslice_sub_3[i]->RotateZ(z);
					}
					break;
				}
			}
...
public:
	...
	vtkSmartPointer<vtkImageSlice> imageslice_sub_3[13];
	...
	vtkSmartPointer<vtkImageResliceMapper> resliceMapper_sub_3[13];
	vtkSmartPointer<vtkImageResliceMapper> resliceMapper_noise_tipup[13];
				
	vtkSmartPointer<vtkImageActor> video_frame_actor[100];

	string video_location_Par_LAX[3];
	string video_location_Par_RVOT[3];
	string video_location_Par_RVIN[3];
	string video_location_Par_SAX_Base[3];
	string video_location_Par_SAX_Mitral[3];

	string video_location_Api_4_Chamber_1[3];
	string video_location_Api_4_Chamber_2[3];
	string video_location_Api_5_Chamber[3];

	string video_location_Sub_Coronal_Anterior[3];
	string video_location_Sub_Coronal_Posterior[3];
	string video_location_Sub_Coronal_Aorta[3];
	
	string video_location_Sub_Transverse[3];
	string video_location_Sub_Longitudanal_Aorta[3];
	string video_location_Sub_Longitudanal_IVC[3];
	
	string video_location_Sub_Sagital_Bicaval[3];
	string video_location_Sub_Sagital_RVOT[3];

	string video_location_Sup_Aortic_Arch[3];
	string video_location_Sup_Ductal_Cut[3];
	string video_location_Sup_Crab_View[3];

	string video_location_Default[3];

	string current_video_location;	 
	...
	vtkSmartPointer<vtkMatrix4x4> matrix_subcostal_3;

	bool video_mode;

	bool guid_is_visible;
	bool orientation_visible;
	bool lock_volume_settings;
	vtkSmartPointer<vtkTextActor> textActor;

	VideoPlayer *videoPlayer;
	int internal_counter_volume_limit;
...
private: 
	...
	int internal_counter_volume_loop;
	
	int video_previous_index;
	int video_current_index;
	int video_current_max_index;
...
#pragma region Initialize Cardiac Windows
	ifstream ranges_file;
	string line;
	
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Parasternal.txt");	

	if(ranges_file.good())
	{
		getline(ranges_file, line);
		vector<string> tokens = callback->Tokenize(line);

		callback->parasternal_range = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Apical.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->apical_range = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Suprasternal.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->suprasternal_range = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Subcostal.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->subcostal_range = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Subcostal_1.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->subcostal_window_1 = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Subcostal_2.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->subcostal_window_2 = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
	...
	ranges_file.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Cardiac Window Ranges\\Subcostal_3.txt");	
	...
	if(ranges_file.good())
	{
		...
		callback->subcostal_window_3 = new Range(atof(tokens[0].c_str()), atof(tokens[1].c_str()), atof(tokens[2].c_str()), atof(tokens[3].c_str()), 
			atof(tokens[4].c_str()), atof(tokens[5].c_str()), atof(tokens[6].c_str()), atof(tokens[7].c_str()),
			atof(tokens[8].c_str()), atof(tokens[9].c_str()), atof(tokens[10].c_str()), atof(tokens[11].c_str()));
...
#pragma region Initialize Heart Rates
	
	callback->internal_counter_video_loop_limit = 1;
	callback->internal_counter_volume_limit = 0;

	ifstream heart_rates;
	
	heart_rates.open ("C:\\VETS Source Code\\VETS 3D\\Heart Rates\\Heart Rate Volume.txt");	

	if(ranges_file.good())
	{
		getline(heart_rates, line);
		callback->internal_counter_volume_limit = atof(line.c_str());
	}

	heart_rates.close();

	heart_rates.open ("C:\\VETS Source Code\\VETS 3D\\Heart Rates\\Heart Rate Video.txt");	

	if(ranges_file.good())
	{
		getline(heart_rates, line);
		callback->internal_counter_video_loop_limit = atof(line.c_str());
	}
...
#pragma region Read Volumes
	...
	ReaderType::Pointer reader_sub_3[13];
	...
	ExportFilterType::Pointer itkExporter_sub_3[13];
	...
	for(int i = 0; i < 13; i++)
	{		
		reader_sub_3[i] = ReaderType::New();
		reader_sub_3[i]->SetFileName(sub_vol_1[i]);
		reader_sub_3[i]->SetImageIO(gdcmImageIO);
		reader_sub_3[i]->Update();

		callback->dimX[Subcostal_3] = reader_sub_3[i]->GetImageIO()->GetDimensions(0);
		callback->dimY[Subcostal_3] = reader_sub_3[i]->GetImageIO()->GetDimensions(1);
		callback->dimZ[Subcostal_3] = reader_sub_3[i]->GetImageIO()->GetDimensions(2);
				
		itkExporter_sub_3[i] = ExportFilterType::New();
		vtkImageImport *vtkImporter = vtkImageImport::New();
		itkExporter_sub_3[i]->SetInput(reader_sub_3[i]->GetOutput());

		ConnectPipelines(itkExporter_sub_3[i], vtkImporter);

		callback->resliceMapper_sub_3[i] = vtkSmartPointer<vtkImageResliceMapper>::New();
		callback->resliceMapper_sub_3[i]->SetInputConnection(vtkImporter->GetOutputPort());
		callback->resliceMapper_sub_3[i]->SliceFacesCameraOn();
		callback->resliceMapper_sub_3[i]->SliceAtFocalPointOn();
		callback->resliceMapper_sub_3[i]->BorderOff();

		callback->imageslice_sub_3[i] = vtkSmartPointer<vtkImageSlice>::New();
		callback->imageslice_sub_3[i]->SetMapper(callback->resliceMapper_sub_3[i]);
		callback->imageslice_sub_3[i]->SetProperty(image_property);
		callback->imageslice_sub_3[i]->SetVisibility(0);
		callback->imageslice_sub_3[i]->SetOrigin(callback->dimX[Subcostal_3]/2, callback->dimY[Subcostal_3]/2, 0);
		renderer->AddViewProp(callback->imageslice_sub_3[i]);
	}
...
#pragma endregion
	...
	callback->video_renderer =	vtkSmartPointer<vtkRenderer>::New();
	for(int i = 0; i < 100; i++)
	{
		callback->video_frame_actor[i] = vtkSmartPointer<vtkImageActor>::New();
		//callback->video_renderer->AddActor(callback->video_frame_actor[i]);
	}

	window->AddRenderer(callback->video_renderer);
...
//	textActor->SetInput ( "Hello world" );
	...
	parasternal_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Parasternal.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
	...
	apical_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Apical.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
	...
	suprasternal_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Suprasternal.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
	...
	subcostal_1_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_1.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
	...
	subcostal_2_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_2.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
	...
	//Subcostal Pos #2
	callback->matrix_subcostal_3 = vtkSmartPointer<vtkMatrix4x4>::New();
	ifstream subcostal_3_angle_settings;
	subcostal_3_angle_settings.open ("C:\\VETS Source Code\\VETS 3D\\Volumes for simulation\\Volume Orientations\\Subcostal_3.txt");
	for(int i = 0; i < 4; i++){
		for(int j = 0; j < 4; j++){
			std::string line;
			std::getline(subcostal_3_angle_settings, line);
			callback->matrix_subcostal_3->SetElement(i,j, std::atof(line.c_str()));
		}
	}
	subcostal_3_angle_settings.close();
	
	for(int i = 0; i < 13; i++){
		callback->imageslice_sub_3[i]->SetUserMatrix(callback->matrix_subcostal_3);
	}
