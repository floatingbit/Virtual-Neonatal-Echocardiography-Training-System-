	...
	{		
		...
		if(event == vtkCommand::KeyPressEvent)
		{
			...
			if(key == "1")
			{
				vtkCamera* cam = this->guid_renderer->GetActiveCamera();
				cam->Roll(90);
				this->guid_renderer->ResetCamera();
			...
			if(key == "9")
			{
				double* point1 = planeWidget->GetPoint1();
				double* point2 = planeWidget->GetPoint2();
...
#pragma endregion
	...
	guid_renderer->SetBackground(0.03, 0.03, 0.03);
