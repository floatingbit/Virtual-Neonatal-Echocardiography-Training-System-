...
public:
	...
	{					
		...
		if(event == vtkCommand::KeyPressEvent)
		{
			...
			cout<<cout<<"Suprasternal orientation"<<imageslice_sup[this->current_volume_index]->GetOrientation()[0]<<" "<<imageslice_sup[this->current_volume_index]->GetOrientation()[1]<<" "<<imageslice_sup[this->current_volume_index]->GetOrientation()[2]<<endl;
