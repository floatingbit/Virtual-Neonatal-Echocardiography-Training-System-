...
public:
	...
	vtkImageInteractionCallback() {
		...
		//this->normal[0] = -1, this->normal[1] = -0.0263223, this->normal[2] = -0.00834897;//for roll
	...
	{		
		...
		if (event == vtkCommand::TimerEvent)
		{
			...
			plane->ProjectPoint( centerofvol, focalPt ); //I need first have a point to project in order to get a projected point. what point am I suppose to project?!
