...
public:
	...
	vtkImageInteractionCallback() {
			...
			this->par_angle_adjust[0] = 0;//-39;
			this->par_angle_adjust[1] = 0;//-2;
			this->par_angle_adjust[2] = 0;//-95;
	...
	{		
		...
		if (event == vtkCommand::TimerEvent)
		{
			...
			guidance_volume->SetOrientation(113, 90, 0);
		...
		if(event == vtkCommand::KeyPressEvent)
		{
			...
			else if(key == "s" && this->adjust_elevation < 90)
			{
				this->adjust_elevation += 1;
			}

			else if(key == "x" && this->adjust_elevation > -90)
			{
				this->adjust_elevation -= 1;
			}
...
#pragma region Read Volumes
	...
	vtkSmartPointer<vtkCamera> cam_guid = guid_renderer->GetActiveCamera();
	cam_guid->SetViewUp(0,0,1);
